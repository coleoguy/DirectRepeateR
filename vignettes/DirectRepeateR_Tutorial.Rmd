...
## Example: Detecting, Converting, and Plotting Repeats
...
res <- GetRepeats(
  file         = "../data/C_elegans_chr1.fasta",
  query_length = 25,
  maxdist      = 20000,
  minlength    = 50,
